...
export default function Login() {
    ...
    return (
        ...
        <div className="h-[100vh] bg-mainBg flex flex-col justify-center items-center">
            ...
            <h1 className="font-bold text-white mb-128 text-h1s lg:text-h1">Lively Chatters</h1>
            
            <div className="flex flex-col items-center w-56">
                <input className="p-32 my-8 text-white rounded-md bg-inputBg" type = "text" name = 'email' placeholder="Email" value={loginInfo.email} onChange={handleChange}></input>
                <input className="p-32 my-8 text-white rounded-md bg-inputBg" type = "password" name = 'password' placeholder="Password" value={loginInfo.password} onChange={handleChange}></input>
